...
import PageWrapper from '../../../components/public/PageWrapper/PageWrapper';
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            {barbeiros.map(barbeiro => (
                                <button
                                    ...
                                    className={`p-4 rounded-xl transition text-center font-medium shadow-sm border ${barbeiroSelecionado === barbeiro
                        ...
                        <div className="flex flex-wrap gap-3">
                            {horarios.map(horario => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg border shadow-sm font-medium transition ${horarioSelecionado === horario
                                        ? 'bg-primary text-white border-primary'
                                        : 'bg-white hover:bg-gray-50 border-gray-300'
                                        }`}
                                >
